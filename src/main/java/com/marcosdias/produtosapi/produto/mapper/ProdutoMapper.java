package com.marcosdias.produtosapi.produto.mapper;
...
public class ProdutoMapper {
	/*
	 * Escolhi também usar um ProdutoMapper para garantir a organização e separação
	 * de responsabilidades, evitando acoplamento entre as camadas da aplicação
	 * (Controller, Service e Model).
	 * 
	 * Dessa forma, a conversão entre DTO e entidade fica centralizada, facilitando
	 * a manutenção e possíveis mudanças futuras.
	 */
	...
	public ProdutoResponseDTO toResponse(Produto produto) {
		return new ProdutoResponseDTO(produto.getId(), produto.getNome(), produto.getPreco(), produto.getDescricao(),
